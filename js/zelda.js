...
(function () {
  ...
  function render() {
    ...
    if (gameState==='win') drawOverlay(ctx,'YOU ESCAPED!','Puzzle solved — great job!','Press JUMP to continue','#ffd700');
    if (gameState==='dead') drawOverlay(ctx,'GAME OVER','You ran out of hearts...','Press JUMP to try again','#ff4444');
    ctx.restore();
  }
